...
# Configure the API key once (best done at the top of your file)
genai.configure(api_key="AIzaSyDRIj0sAHmZdQIw2bipPxCfdmeNbfsaJdA")

def aireply(command):
    """Generate a response from the AI model."""
    try:
        model = genai.GenerativeModel("gemini-1.5-flash")  # or "gemini-1.0-pro", etc.
